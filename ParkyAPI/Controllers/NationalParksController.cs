...
namespace ParkyAPI.Controllers
{
    ...
    public class NationalParksController : Controller
    {
        ...
        public IActionResult CreateNationalPark([FromBody] NationalParkDto nationalParkDto)
        {
            ...
            if (_nationalParkRepository.NationaParkExists(nationalParkDto.Name))
            {
            ...
            if (!_nationalParkRepository.CreateNationaPark(nationalParkObj))
            {
        ...
        public IActionResult UpdateNationalPark(int nationalParkId, [FromBody] NationalParkDto nationalParkDto)
        {
            ...
            if (!_nationalParkRepository.UpdateNationaPark(nationalParkObj))
            {
        ...
        {
            if (!_nationalParkRepository.NationaParkExists(nationalParkId))
            {
                return NotFound();
            }
            var nationalParkObj = _nationalParkRepository.GetNationalPark(nationalParkId);
            if (!_nationalParkRepository.DeleteNationaPark(nationalParkObj))
            {
